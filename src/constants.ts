...
export const OS_CATALOG: OSConfig[] = [
  ...
  { id: "debian", name: "Debian 12", category: "Linux", isoUrl: "https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-12.5.0-amd64-netinst.iso", officialSite: "https://www.debian.org/distrib/" },
  { id: "arch", name: "Arch Linux", category: "Linux", isoUrl: "https://geo.mirror.pkgbuild.com/iso/2024.05.01/archlinux-2024.05.01-x86_64.iso", officialSite: "https://archlinux.org/download/" },
