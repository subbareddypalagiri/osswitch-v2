...
export const OS_CATALOG: OSConfig[] = [
  { id: "ubuntu", name: "Ubuntu 24.04 LTS", category: "Linux", isoUrl: "https://releases.ubuntu.com/24.04/ubuntu-24.04-desktop-amd64.iso", officialSite: "https://ubuntu.com/download/desktop" },
  { id: "kali", name: "Kali Linux 2024.2", category: "Security", isoUrl: "https://cdimage.kali.org/kali-2024.2/kali-linux-2024.2-installer-amd64.iso", officialSite: "https://www.kali.org/get-kali/#kali-installer-images" },
  ...
  { id: "fedora", name: "Fedora Workstation 40", category: "Linux", isoUrl: "https://download.fedoraproject.org/pub/fedora/linux/releases/40/Workstation/x86_64/iso/Fedora-Workstation-Live-x86_64-40-1.14.iso" },
  { id: "pop", name: "Pop!_OS 22.04", category: "Linux", isoUrl: "https://iso.pop-os.org/22.04/amd64/intel/pop-os_22.04_amd64_intel_34.iso" },
  { id: "debian", name: "Debian 12", category: "Linux", isoUrl: "https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-12.5.0-amd64-netinst.iso" },
  { id: "arch", name: "Arch Linux", category: "Linux", isoUrl: "https://geo.mirror.pkgbuild.com/iso/2024.05.01/archlinux-2024.05.01-x86_64.iso" },
  { id: "mint", name: "Linux Mint 21.3", category: "Linux", isoUrl: "https://mirrors.kernel.org/linuxmint/stable/21.3/linuxmint-21.3-cinnamon-64bit.iso" },
  { id: "manjaro", name: "Manjaro KDE", category: "Linux", isoUrl: "https://download.manjaro.org/kde/23.1.4/manjaro-kde-23.1.4-240406-linux66.iso" },
  { id: "centos", name: "CentOS Stream 9", category: "Server", isoUrl: "https://mirrors.centos.org/mirrorlist?path=9-stream/BaseOS/x86_64/iso/CentOS-Stream-9-latest-x86_64-dvd1.iso" },
  { id: "rocky", name: "Rocky Linux 9", category: "Server", isoUrl: "https://download.rockylinux.org/pub/rocky/9/isos/x86_64/Rocky-9.3-x86_64-dvd.iso" },
  { id: "almalinux", name: "AlmaLinux 9", category: "Server", isoUrl: "https://repo.almalinux.org/almalinux/9/isos/x86_64/AlmaLinux-9.3-x86_64-dvd.iso" },
  { id: "opensuse", name: "openSUSE Tumbleweed", category: "Linux", isoUrl: "https://download.opensuse.org/tumbleweed/iso/openSUSE-Tumbleweed-DVD-x86_64-Current.iso" },
  { id: "chromeos", name: "ChromeOS Flex", category: "Linux", isoUrl: "https://dl.google.com/chromeos-flex/images/latest.bin.zip" },
  { id: "oracle", name: "Oracle Linux", category: "Server", isoUrl: "https://yum.oracle.com/ISOS/OracleLinux/OL9/u3/x86_64/OracleLinux-R9-U3-x86_64-dvd.iso" },
