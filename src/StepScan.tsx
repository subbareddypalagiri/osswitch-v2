...
export default function StepScan({ 
  ...
  return (
    <div className="w-full h-full flex flex-col items-center pt-8 pb-4">
      <div className="bg-white/95 dark:bg-[#111522]/95 border border-[#e2d8cc] dark:border-white/10 rounded-3xl max-w-[840px] p-8 w-full animate-[fadeIn_0.3s_ease-out] flex flex-col shadow-[0_20px_50px_rgba(180,140,100,0.12)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.4)]">
        ...
        <div className="flex-grow">
          {error ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {/* CPU Card */}
              <div className="bg-[#fbf8f3] dark:bg-white/[0.02] border border-[#ebe3d5] dark:border-white/10 p-5 rounded-2xl flex flex-col justify-between hover:border-amber-700/30 dark:hover:border-white/20 transition-colors shadow-sm">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-8 h-8 rounded-lg bg-amber-500/10 dark:bg-blue-500/10 border border-amber-500/20 dark:border-blue-500/20 text-amber-700 dark:text-blue-400 flex items-center justify-center">
                    <Cpu className="w-4 h-4" />
                  </div>
                  <span className="text-stone-500 dark:text-slate-400 text-xs font-mono font-semibold uppercase tracking-wider">Processor</span>
                </div>
                <span className="text-base text-stone-900 dark:text-white font-bold tracking-tight">{sysInfo.cpu}</span>
              </div>
              ...
              <div className="bg-[#fbf8f3] dark:bg-white/[0.02] border border-[#ebe3d5] dark:border-white/10 p-5 rounded-2xl flex flex-col justify-between hover:border-amber-700/30 dark:hover:border-white/20 transition-colors shadow-sm">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-stone-500 dark:text-slate-400 text-xs font-mono font-semibold uppercase tracking-wider">System Memory</span>
                </div>
                <span className="text-base text-stone-900 dark:text-white font-bold tracking-tight">{formatBytes(sysInfo.ram_gb * 1024 * 1024 * 1024)}</span>
              </div>
              ...
              <div className="bg-[#fbf8f3] dark:bg-white/[0.02] border border-[#ebe3d5] dark:border-white/10 p-5 rounded-2xl flex flex-col justify-between hover:border-amber-700/30 dark:hover:border-white/20 transition-colors shadow-sm">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-stone-500 dark:text-slate-400 text-xs font-mono font-semibold uppercase tracking-wider">Available Storage</span>
                </div>
                <span className="text-base text-stone-900 dark:text-white font-bold tracking-tight">{formatBytes(sysInfo.disk_free_gb * 1024 * 1024 * 1024)} Free</span>
              </div>

              {/* Virtualization Card */}
              <div className="bg-[#fbf8f3] dark:bg-white/[0.02] border border-[#ebe3d5] dark:border-white/10 p-5 rounded-2xl flex flex-col justify-between hover:border-amber-700/30 dark:hover:border-white/20 transition-colors shadow-sm">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-8 h-8 rounded-lg bg-teal-500/10 border border-teal-500/20 text-teal-700 dark:text-cyan-400 flex items-center justify-center">
                    <ShieldCheck className="w-4 h-4" />
                  </div>
                  <span className="text-stone-500 dark:text-slate-400 text-xs font-mono font-semibold uppercase tracking-wider">VT-x / AMD-V Hardware Acceleration</span>
                </div>
            ...
            <div className="flex flex-col justify-center items-center py-20">
              ...
              <span className="text-stone-500 dark:text-slate-400 text-xs font-mono">Querying hardware descriptors...</span>
            </div>
          )}
        </div>
