    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-md p-4">
        <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-10 max-w-[600px] shadow-[0_0_50px_rgba(239,68,68,0.2)] flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-4">Pre-Flight Safety Check Failed</h2>
          <p className="text-slate-300 mb-8">{error}</p>
          <button 
            className="bg-red-600 hover:bg-red-500 text-white font-bold py-3 px-8 rounded-xl transition-colors shadow-[0_0_20px_rgba(239,68,68,0.4)]"
  ...
  if (loading) {
    return (
      <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/90 backdrop-blur-md">
        ...
        <h2 className="text-xl font-bold text-white tracking-widest uppercase text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 mb-2">
