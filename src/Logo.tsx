const Logo = ({ className = "" }: { className?: string }) => {
  return (
    ...
    >
      <defs>
        <linearGradient id="oswitchBrandGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#3b82f6" />
          <stop offset="100%" stopColor="#6366f1" />
        </linearGradient>
        <linearGradient id="oswitchInnerGrad" x1="0%" y1="100%" x2="100%" y2="0%">
      ...
      <rect x="6" y="6" width="88" height="88" rx="24" fill="#0f172a" stroke="rgba(255, 255, 255, 0.12)" strokeWidth="2" />
      
      {/* Outer Switch Orbital Ring */}
      <circle cx="50" cy="50" r="30" stroke="url(#oswitchBrandGrad)" strokeWidth="6" strokeDasharray="120 40" strokeLinecap="round" />
      
      {/* Central Interlocking Switch Nodes */}
      <circle cx="40" cy="50" r="10" fill="url(#oswitchBrandGrad)" />
      <circle cx="60" cy="50" r="10" fill="url(#oswitchInnerGrad)" />
      <path d="M40 44L60 56" stroke="white" strokeWidth="3.5" strokeLinecap="round" />
    </svg>
  );
};
